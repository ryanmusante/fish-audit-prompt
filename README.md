...
![version](https://img.shields.io/badge/version-7.3.5-blue)
![license](https://img.shields.io/badge/license-MIT-green)
![fish](https://img.shields.io/badge/fish-3.6%2B-orange)
![checks](https://img.shields.io/badge/checks-431-brightgreen)
...
Derived from `ry-install.fish` v7.3.5 · 431 checks across 15 phases · Prompt v7.3.5
...
| Metric | Value |
|---|---|
| Checks | 431 (420 static + 11 runtime) |
| Phases | 15 |
| Passes | 3 |
